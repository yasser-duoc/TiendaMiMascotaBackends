...
public interface OrdenRepository extends JpaRepository<Orden, Long> {
    ...
    Page<Orden> findByEstadoOrderByFechaDesc(String estado, Pageable pageable);

    Page<Orden> findByUsuarioIdAndEstadoOrderByFechaDesc(Long usuarioId, String estado, Pageable pageable);
